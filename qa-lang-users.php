...
*/
	...
	return array(
		...
		'password_none' => 'Κανένα. Για να συνδεθείτε απευθείας, θέστε έναν κωδικό παρακάτω.',
		'password_sent' => 'Ο νέος σας κωδικός έχει αποσταλεί με ηλεκτρονικό μήνυμα',
