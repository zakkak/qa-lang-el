...
*/
	...
	return array(
		'block_ip_button' => 'Μπλοκάρισμα διεύθυνσης IP',
		...
		'feed_a_prefix' => 'Απαντήθηκε: ',
		'feed_a_reshown_prefix' => 'Η απάντηση ξαναπροβλήθηκε: ',
		'feed_a_selected_prefix' => 'Η απάντηση επιλέχθηκε: ',
		'feed_c_edited_prefix' => 'Το σχόλιο επεξεργάσθηκε: ',
		'feed_c_moved_prefix' => 'Το σχόλιο μετακινήθηκε: ',
		'feed_c_prefix' => 'Σχολιάστηκε: ',
		'feed_c_reshown_prefix' => 'Το σχόλιο ξαναπροβλήθηκε: ',
		'feed_closed_prefix' => 'Έκλεισε: ',
		'feed_edited_prefix' => 'Επεξεργάσθηκε: ',
		'feed_hidden_prefix' => 'Έγινε κρυφό: ',
		'feed_not_found' => 'Δεν βρέθηκε το feed',
		'feed_recategorized_prefix' => 'Επανακατηγοριοποιήθηκε: ',
		'feed_reopened_prefix' => 'Ξανάνοιξε: ',
		'feed_reshown_prefix' => 'Επανεμφανίστηκε: ',
		'feed_retagged_prefix' => 'Retagged: ',
		'feedback_email' => 'Ηλεκτρονική διεύθυνση: (προαιρετικό)',
		'feedback_empty' => 'Παρακαλώ χρησιμοποιήστε αυτό το πεδίο για να στείλετε σχόλια ή προτάσεις',
		'feedback_message' => 'Τα σχόλια ή προτάσεις για ^:',
		'feedback_name' => 'Όνομα: (προαιρετικό)',
		'feedback_sent' => 'Το μήνυμα εστάλη - ευχαριστούμε.',
		'feedback_title' => 'Αποστολή σχολίων',
		'form_security_again' => 'Παρακαλώ κάντε click ξανά για επιβεβαίωση',
		...
		'no_favorite_tags' => 'Καμία αγαπημένη ετικέτα',
		'no_favorite_users' => 'Κανένας αγαπημένος χρήστης',
